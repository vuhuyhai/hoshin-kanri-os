...
export function XRayPrefillBanner({
  ...
  return (
    <div
      className="flex items-start gap-3 border-2 border-ink bg-white p-4"
...
export function XRayBadge() {
  return (
    <span className="inline-flex items-center gap-1 text-[10px] font-display font-bold bg-white border-2 border-ink px-1.5 py-0.5 ml-2 text-ink">
  ...
  return (
    <div className="w-full space-y-6 animate-pulse">
      <div className="space-y-2">
        <div className="h-4 w-24 bg-[#ECEAE6] border-2 border-ink" />
        <div className="h-8 w-64 bg-[#ECEAE6] border-2 border-ink" />
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="h-12 bg-[#ECEAE6] border-2 border-ink" />
        <div className="h-12 bg-[#ECEAE6] border-2 border-ink" />
      </div>
      <div className="h-20 bg-[#ECEAE6] border-2 border-ink" />
      <div className="h-20 bg-[#ECEAE6] border-2 border-ink" />
      <div className="h-20 bg-[#ECEAE6] border-2 border-ink" />
    </div>
  )
