  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex-1 min-h-0 flex overflow-hidden">
        <div className={`lg:w-[45%] lg:flex lg:border-r-2 lg:border-ink ${tab === 'chat' ? 'flex w-full' : 'hidden'}`}>
          <SwotWorkshopChat orgId={orgId} onAddIngredient={handleChatAdd} />
        </div>
        <div className={`lg:w-[55%] lg:block overflow-y-auto p-4 ${tab === 'panel' ? 'block w-full' : 'hidden'}`}>
          {isDrafting && (
