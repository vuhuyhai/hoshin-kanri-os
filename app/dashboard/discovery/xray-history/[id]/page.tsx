    ...
    <>
      <div className="mb-4 flex items-center justify-between px-6 md:px-12 lg:px-20 pt-4">
        <Link
          ...
          className="inline-flex items-center gap-2 border-2 border-ink bg-accent-brand text-white px-4 py-2 font-bold text-sm shadow-[3px_3px_0_#2C2B2B] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px] transition-all"
        >
