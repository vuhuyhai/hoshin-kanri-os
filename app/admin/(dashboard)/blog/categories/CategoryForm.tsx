...
const EMPTY: CategoryInitial = { slug: '', name: '', description: '' }
...
export function CategoryForm({
  ...
  // Reset the form after a successful create (used by the inline
  // "add new" form at the top of the categories page).
  ...
  return (
    <form action={formAction} className={compact ? 'space-y-3' : 'space-y-5'}>
      ...
      <div className={compact ? 'grid grid-cols-1 gap-3 md:grid-cols-3' : 'space-y-4'}>
        <div>
          ...
          <input
            ...
            placeholder="Ví dụ: Hoshin Kanri"
          />
          {fieldErrors.name && (
        ...
        <div>
          ...
          <input
            ...
            maxLength={300}
            className="mt-1.5 w-full border-[3px] border-ink bg-bg-warm px-3 py-2 font-body text-sm text-ink focus:outline-none focus:shadow-[4px_4px_0_#c73937]"
            placeholder="Ngắn gọn, dùng cho filter chip"
          />
